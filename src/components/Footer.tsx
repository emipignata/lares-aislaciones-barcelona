...
const Footer = () => {
  ...
  return (
    <footer className="bg-lares-900 text-white pt-16 pb-8">
      <div className="container mx-auto container-padding">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <Shield className="w-6 h-6 text-lares-300" />
              <h3 className="text-xl font-bold text-white">
                Lares <span className="text-lares-300">Aislaciones</span>
              </h3>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-gray-300">info@laresaislaciones.com</li>
            </ul>
          </div>
        </div>
